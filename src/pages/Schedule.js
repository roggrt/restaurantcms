...
// //       if (locationId) {
// //         const locationRef = doc(db, 'contact_info', 'contact', 'location', locationId);
// //         await updateDoc(locationRef, locationData);
// //       } else {
// //         const locationsRef = collection(doc(db, 'contact_info', 'contact'), 'location');
...
//       } else {
//         // Si no tiene ID, es una nueva ubicación
...
//   // Manejadores para horario regular
...
//           dayOrder: scheduleData.dayOrder || '',
//           isActive: scheduleData.isActive || true,
//           isOpen: scheduleData.isOpen || true,
